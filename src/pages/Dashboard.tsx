    ...
    <div className="p-4 md:p-6 space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => fetchSales()} disabled={loading}><RefreshCw size={16} className={`mr-2 ${loading ? 'animate-spin' : ''}`}/>Actualiser</Button>
          <Button onClick={() => navigate('/ventes')}><ShoppingCart size={16} className="mr-2"/>Nouvelle Vente</Button>
        </div>
      </div>
